...
#icon
image_icon = PhotoImage(file="426426.png")
...
Label(Top_frame, text="TEXT TO SPEECH", font="arial 20 bold", bg="white", fg="black").place(x=350,y=30)
...
btn = Button(root, text="Speak", width=10, bg="#39c990", font="arial 14 bold", command=speaknow)
